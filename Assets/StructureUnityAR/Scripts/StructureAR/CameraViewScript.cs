...
namespace StructureAR
{
    ...
    public class CameraViewScript
    {
        ...
        public CameraViewScript(Camera camera, float distance)
        {
			...
			//float fWidth = (float)(1f * 16.0f/9.0f);
            ...
            this.CameraObject.transform.position = new Vector3(0, 10, 0); //-1000
			this.CameraObject.transform.localScale = new Vector3 (1, -1, 1);
			//this.CameraObject.transform.localScale = new Vector3(640.0f/480.0f, 
			//													 -540.0f/480.0f, 1f);
